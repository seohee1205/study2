...
x_train, x_test, y_train, y_test = train_test_split(
    x, y, shuffle = True, train_size = 0.9, random_state= 345
)
...
hist = model.fit(x_train, y_train, epochs = 300, batch_size = 60,
...
path_save = './_save/kaggle_bike/'
submission.to_csv(path_save + 'submit_0311_0636.csv')import numpy as np
from tensorflow.python.keras.models import Sequential
from tensorflow.python.keras.layers import Dense
from sklearn.model_selection import train_test_split
from sklearn.metrics import r2_score, mean_squared_error
...
path_save = './_save/kaggle_bike/'
submission.to_csv(path_save + 'submit_0311_0636.csv')
