...
x_train, x_test, y_train, y_test = train_test_split(
    x, y, shuffle = True, train_size = 0.95, random_state = 3528
)
                                                                # 결측치 제거 후
...
es = EarlyStopping(monitor= 'val_loss', patience = 40, mode= 'min',     # if mode = auto: 자동으로 min 또는 max로 맞춰줌 
              verbose= 1,    
              restore_best_weights= True)  


hist = model.fit(x_train, y_train, epochs = 1200, batch_size = 22,
...
submission.to_csv(path_save + 'submit_0311_0724.csv')

# loss :  2021.4190673828125
# r2 스코어 :  0.5173573111464841
# RMSE :  44.960194258181666
