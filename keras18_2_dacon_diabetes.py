...
x_train, x_test, y_train, y_test = train_test_split(
    x, y, shuffle= True, train_size= 0.9, random_state= 8367739, stratify = y
)
...
# 정의하기
es = EarlyStopping(monitor = 'val_accuracy', patience = 151, mode = 'max',
                   verbose = 1,
                    restore_best_weights = True)

hist = model.fit(x_train, y_train, epochs = 3000, batch_size = 18,
...
path_save = './_save/dacon_diabetes/'
submission.to_csv(path_save + 'submit_0311_0805.csv')
